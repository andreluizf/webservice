...
//    }
	...
	public String toString() {
		return "Nutricionista [codigo=" + codigo + ", crn=" + crn + ", regiao="
				+ regiao + ", nomeClinica=" + nomeClinica + ", subdominio="
				+ subdominio + ", nome=" + nome + ", sexo=" + sexo + ", email="
				...
				+ ", idioma=" + idioma + ", valorMensalidade="
				+ valorMensalidade + ", dataInicio=" + dataInicio
				+ ", dataFimTeste=" + dataFimTeste + ", diaVencimentoBoleto="
				+ diaVencimentoBoleto + ", gratuito=" + gratuito + ", imagem="
				+ imagem + ", ativo=" + ativo + ", mailAtivo=" + mailAtivo
				+ ", mailing=" + mailing + ", cor=" + cor + ", pago=" + pago
				+ "]";
	}
